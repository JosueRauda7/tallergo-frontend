      ...
      <div className='menu flex sm:flex-col md:flex-row lg:flex-row items-center bg-blue-600 text-white p-4 shadow-lg'>
        ...
        <nav className='ml-auto cursor-pointer'>
          <div
            ...
            className='md:hidden sm:flex flex items-center'>
            <svg
          ...
          {!isMobile && showMenu && (
            <ul className='lg:flex lg:flex-row md:flex md:flex-row space-x-4'>
              <>
                <Link
                  to='/'
                  className='nav-option-desktop text-gray-100 hover:text-shadow-2xs hover:text-white cursor-pointer'>
                  Inicio
                </Link>
                <Link
                  to='/talleres'
                  className='nav-option-desktop text-gray-50 hover:text-white cursor-pointer'>
                  Talleres
                </Link>
                {(userType === "Administrador" ||
                  userType === "Gestor de Taller") && (
                  <Link
                    to='/administrar'
                    className='nav-option-desktop text-gray-50 hover:text-white cursor-pointer'>
                    Administrar
        ...
        <ul className='flex flex-col space-x-4 bg-blue-700 shadow-lg'>
          <>
            <Link
              to='/'
              onClick={() => setShowMenu(!showMenu)}
              className='text-gray-100 p-4 hover:text-white hover:bg-blue-600 active:text-white active:bg-blue-800 cursor-pointer'>
              Inicio
            </Link>
            <Link
              to='/talleres'
            ...
            <p
              ...
              className='text-gray-100 p-4 hover:text-white hover:bg-cyan-700 active:text-white active:bg-cyan-800 cursor-pointer'>
              Cerrar Sesión
            </p>
          </>
        </ul>
